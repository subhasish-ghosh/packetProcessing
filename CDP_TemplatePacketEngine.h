/**
 * @file CDP_TemplatePacketEngine.h
 * @brief Battery Template Class
 * @author Subhasish Ghosh
 */

#ifndef CODINGTEST_CDP_TEMPLATEPACKETENGINE_H
#define CODINGTEST_CDP_TEMPLATEPACKETENGINE_H
 ...
 * @brief The Singleton Battery Template Class
 */
class CDP_TemplatePacketEngine : public CDP_BatteryPackets{
public:
    ...
    void cdp_dbg(Args &&... args) {
        if (CDP_BatteryLogger::getLogLevel() >= CDP_LOGGER_LEVEL_DBG) {
            ...
            (stream << ... << args);
            std::cout << "CDP_TemplatePacketEngine: " << stream.str() << '\n';
        }
    }
...
private:
     ...
     */
    inline static const CDP_BatteryPacketsType_t type = CDP_BatteryPackets::CDP_BatteryPacketsType::CDP_PACKETSTYPE_BATTERYTEMPLATE;
    /**
     * @var datalen
     ...
     */
    inline static const std::string name = "Example Battery Template";
    /**
     * @var objInit
    ...
    /**
     * @var cdpBatteryTemplate
     * @brief This variable is the Singleton Class Object
     */
    inline static CDP_TemplatePacketEngine *cdpBatteryTemplate = nullptr;
    /**
    ...
    CDP_TemplatePacketEngine();

    CDP_TemplatePacketEngine(const CDP_TemplatePacketEngine &);

    CDP_TemplatePacketEngine &operator=(const CDP_TemplatePacketEngine &);
};

#endif //CODINGTEST_CDP_TEMPLATEPACKETENGINE_H
